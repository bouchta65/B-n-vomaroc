                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div class="overflow-x-auto -mx-4 px-4 md:mx-0 no-scrollbar mb-4 md:mb-0">
                        <div class="flex items-center space-x-3 min-w-max">
                            ...
                            <div class="flex items-center bg-gray-50 rounded-lg px-3 py-1.5">
                                ...
                                <span class="current-date text-sm font-medium text-gray-600"></span>
                            ...
                            <div class="flex items-center bg-gray-50 rounded-lg px-3 py-1.5">
                                ...
                                <span  class="current-time text-sm font-medium text-gray-600"></span>
                    ...
                    <div class="overflow-x-auto -mx-4 px-4 md:mx-0">
                        <nav class="flex space-x-6 min-w-max">
                            <a href="{{ url('Bénévoles') }}" 
                            class="flex items-center py-2 border-b-2 transition-colors duration-200 group {{ request()->is('Bénévoles') ? 'border-[#00B3AD] text-[#00B3AD]' : 'border-transparent text-gray-600' }}">
                             <svg class="w-5 h-5 mr-2 {{ request()->is('Bénévoles') ? 'text-[#00B3AD]' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                             </svg>
                             <span class="text-sm font-medium whitespace-nowrap {{ request()->is('Bénévoles') ? 'text-[#00B3AD]' : 'text-gray-600' }}">
                                 Bénévoles
                             </span>
                         </a>
    
                            <a href="{{ url('associations') }}" class="flex items-center py-2 border-b-2 transition-colors duration-200 group {{ request()->is('associations') ? 'border-[#00B3AD] text-[#00B3AD]' : 'border-transparent text-gray-600' }}">
                                <svg class="w-5 h-5 mr-2 {{ request()->is('associations') ? 'text-[#00B3AD]' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                </svg>
                                <span class="text-sm font-medium whitespace-nowrap {{ request()->is('associations') ? 'text-[#00B3AD]' : 'text-gray-600' }}">Associations</span>
                            </a>

                            <a href="{{ url('formations') }}" class="flex items-center py-2 border-b-2 transition-colors duration-200 group {{ request()->is('formations') ? 'border-[#00B3AD] text-[#00B3AD]' : 'border-transparent text-gray-600' }}">
                                <svg class="w-5 h-5 mr-2 {{ request()->is('formations') ? 'text-[#00B3AD]' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                                <span class="text-sm font-medium whitespace-nowrap {{ request()->is('formations') ? 'text-[#00B3AD]' : 'text-gray-600' }}">Formation</span>
                            </a>

                            <a href="{{ url('guide-Juridique') }}" class="flex items-center py-2 border-b-2 transition-colors duration-200 group {{ request()->is('guide-Juridique') ? 'border-[#00B3AD] text-[#00B3AD]' : 'border-transparent text-gray-600' }}">
                                <svg class="w-5 h-5 mr-2 {{ request()->is('guide-Juridique') ? 'text-[#00B3AD]' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                                </svg>
                                <span class="text-sm font-medium whitespace-nowrap {{ request()->is('guide-Juridique') ? 'text-[#00B3AD]' : 'text-gray-600' }}">Guide Juridique</span>
                            </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-16">
            <div class="space-y-4 lg:col-span-2 text-center md:text-left">
                ...
                <div class="text-xs text-gray-400 pt-2">
                    ...
                    <p><span class="current-date"></span>  <span class="current-time"></span></p>
